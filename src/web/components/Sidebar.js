...
const SidebarNavItems = () => (
  <div>
    ...
    <NavItem>
      <Link className={`nav-link ${window.location.pathname.startsWith('/recipe') && 'active'}`} to="/football">
        <i className="icon-notebook" /> <span>Football</span>
      </Link>
    </NavItem>
    <NavItem>
      <Link className={`nav-link ${window.location.pathname.startsWith('/recipe') && 'active'}`} to="/basketball">
        <i className="icon-notebook" /> <span>Basketball</span>
      </Link>
    </NavItem>
  </div>
);
