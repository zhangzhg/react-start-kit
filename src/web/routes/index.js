...
import FootballViewComponent from '../components/Football';
import BasketballViewComponent from '../components/Basketball';

import FootballContainer from '../../containers/Football';
import BasketballContainer from '../../containers/Basketball';
...
const Index = () => (
  <Switch>
    ...
    <Route
      ...
      render={props => (
        <TemplateSidebar>
          <FootballContainer {...props} Layout={FootballViewComponent} />
        </TemplateSidebar>
      )}
    />
    <Route
      ...
      render={props => (
        <TemplateSidebar>
          <FootballContainer {...props} Layout={BasketballViewComponent} />
        </TemplateSidebar>
      )}
    />
    <Route
